...
<\body>
  ...
  Drawin's finches is not the object of research, but the distribution of a
  ...
  turn of the 20th century.(wikipedia). It is intersting that, the biometric
  ...
  <section*|Finsher\VThe 14 years in Rothamsted Experiment Station>

  \;

  <with|font-series|bold|Sir Ronald Aylmer Fisher FRS> (17 February 1890 -29
  July 1962), was a Brithsh statistician and geneticist. In 1919, he began
  working at the Rothamsted Experimental Station for 14 years, where he
  analysed its immense data fro m crop experiments since the 1840s., and
  developed the anaylsis of variance(ANOVA).\ 

  \;

  The usage of chi-square and P value.
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|Finsher
